...
# MEMMORY
when we start a program the code stored in binary in SSD/HDD get transtered to ram (random aceess memmory)

a program cannt directly access the physical memmory.
...
the work of converting virtual memmory to physical memory is work of MMU in CPU.
